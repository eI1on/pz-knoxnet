...
local Constants = require("KnoxNet/modules/games/Constants")
...
function PacmanGame:preview(x, y, width, height, terminal, gamesModule)
	...
	local pacmanTexture = getTexture("media/ui/KnoxNet/games/pacman/ui_knoxnet_pacman_pacman_left.png")
	local ghostTexture = getTexture("media/ui/KnoxNet/games/pacman/ui_knoxnet_pacman_blinky.png")
	local cherryTexture = getTexture("media/ui/KnoxNet/games/pacman/ui_knoxnet_pacman_cherry.png")
...
local GamesModule = require("KnoxNet/modules/games/Module")
